    ...
    return (
      <div className="fontcontrolbox-component">
        ...
        <label htmlFor="size">
          ...
          <input type="range" value={size} id="size" onChange={this._handleChange} max="150"/>
          </label><br/>
        <label htmlFor="lineheight">
          {" Lineheight: "} {lineHeight}
          <input type="range" value={lineHeight} id="lineHeight" max="3" onChange={this._handleChange}/>
          </label><br/>
        <label htmlFor="kearning">
          {" Kearning: "} {kearning}
          <input type="range" value={kearning} id="kearning" onChange={this._handleChange}/>
          </label><br/>
        <label htmlFor="marginAfter">
          {" MarginAfter: "} {marginAfter}
          <input type="range" value={marginAfter} id="marginAfter" onChange={this._handleChange}/>
          </label><br/>
      </div>
    );
  }
